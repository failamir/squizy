...
<html lang="en">
    <head>
        ...
        <!-- Maths css -->
        <link href="css/mathquill.min.css" rel="stylesheet">
                                    ...
                                    <div class="row">
                                        <form id="register_form" method="POST" action="db_operations.php" data-parsley-validate="" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate="novalidate">
                                            ...
                                            <?php if (isset($_GET['id'])) { ?>
                                                <input type="hidden" id="question_id" name="question_id" required="<?= $_GET['id']; ?>" value="1" aria-required="true">
                                            <?php } ?>                                           
                                            ...
                                            if (isset($_GET['id'])) {
                                                ...
                                                if (!empty($res)) {
                                                    ...
                                                    ?>
                                                    <input type="hidden" id="image_url" name="image_url" required="<?= ($res[0]['image']) ? 'images/maths-question/' . $res[0]['image'] : ''; ?>" value="1" aria-required="true">
                                                    <?php
                                                }
                                            }
