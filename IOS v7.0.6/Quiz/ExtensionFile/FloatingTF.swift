...
public extension String {
  ...
  func substring(_ r: Range<Int>) -> String {
   ...
   // return self.substring(with: Range<String.Index>(uncheckedBounds: (lower: fromIndex, upper: toIndex))) //swift3
...
//    bottomLineLayer.frame = CGRect(x: 0, y: self.frame.size.height - 1, width: self.frame.size.width, height: 2)
  ...
  public var titleFont : UIFont = UIFont.systemFont(ofSize: 10)//14
